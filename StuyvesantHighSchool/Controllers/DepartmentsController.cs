...
namespace StuyvesantHighSchool.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        {
            var stuyDbContext = _context.Departments.Include(d => d.Admin);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DepartmentID,Name,TeacherID")] Department department)
        {
